        ...
        <div className="relative">
            ...
            <div className={`bg-gray-400 rounded absolute left-0 right-0 top-full translate-y-1 ${isOpen ? "h-14" : "h-0"} overflow-hidden custom-duration`}>
                <ul className='space-y-1'>
                    <li className='bg-transparent hover:bg-gray-300 px-1 cursor-pointer custom-duration rounded'>EN</li>
                    <li className='bg-transparent hover:bg-gray-300 px-1 cursor-pointer custom-duration rounded'>AR</li>
                </ul>
            </div>
        </div>
    )
